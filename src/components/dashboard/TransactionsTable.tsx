  ...
  return (
    <section className="panel movements" id="movimientos">
      ...
      {!isLoaded ? <div className="empty"><span>Cargando movimientos…</span></div> : totalCount === 0 ? (
        ...
        <div className="empty"><b>No encontramos resultados</b><span>Prueba con otros filtros o limpia la búsqueda.</span><button className="filter-reset" onClick={() => onFiltersChange({ search: "", kind: "all", category: "", date: "" })}>Limpiar filtros</button></div>
      ) : (
